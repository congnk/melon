...
<?php include '../inc/nav.php';?>
	<div class="ui-box">
		<div class="ui-box-head">
			...
			<a href="#" class="ui-box-head-more">其他相关内容</a>
		</div>
		<div class="ui-box-container">
			<div class="ui-box-content">新增表单样式</div>
		</div>
	</div>
    ...
    <fieldset>
        ...
        <div class="ui-form-item">
            ...
            <a href="#" onclick="return false">看不清，换一张</a>
        ...
        <div class="ui-form-item">
            <input type="submit" class="ui-button ui-button-mgreen" value="确定">
...
<script>
	...
	$(function(){
		$("#alice_nav li:eq(2)").addClass("ui-nav-subitem-current");
		
		$(".ui-checkcode-imgcode-img").click(function(){
			getCheckCodeImg();
		});
		$(".ui-checkcode-imgcode-img").next("a").click(function(){
			getCheckCodeImg();
			e.preventDefault();
		});
	...
	function getCheckCodeImg(){
		...
		$(".ui-checkcode-imgcode-img").attr("src",'https://omeo.alipay.com/service/checkcode?sessionID=82012ab6b1f4ed9e675fb9092a25cb3b&r='
		+ mills);
	}
